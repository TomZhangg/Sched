...
./schedch.native -s tests/create_statement/sast/create.sched > tests/create_statement/sast/create.sched.out.tmp
...
./schedch.native -a tests/if_else_parsing/_smoke/ifelse.sched > tests/if_else_parsing/_smoke/ifelse.sched.out.tmp
...
./schedch.native -s tests/if_else_parsing/_smoke/ifelse.sched > tests/if_else_parsing/_smoke/ifelse.sched.s_out.tmp
./schedch.native -l tests/if_else_parsing/_smoke/ifelse.sched > tests/if_else_parsing/_smoke/ifelse.sched.l_out.tmp
...
cmp --silent tests/create_statement/sast/create.sched.out tests/create_statement/sast/create.sched.out.tmp && echo '### SUCCESS: Files Are Identical! ###' || echo '### WARNING: Files Are Different! ###'
